...
namespace SacMP.Controllers
{
    public class MeetingPlansController : Controller
    {
        private readonly SacMPContext _context;

        public MeetingPlansController(SacMPContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,MeetingDate,ConductingLeader,PresidingLeader,OpeningHymn,OpeningPrayer,SacramentHymn,speakerOne,speakerTwo,MusicalNumber,speakerThree,speakerFour,ClosingHymn,ClosingPrayer")] MeetingPlan meetingPlan)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,MeetingDate,ConductingLeader,PresidingLeader,OpeningHymn,OpeningPrayer,SacramentHymn,speakerOne,speakerTwo,MusicalNumber,speakerThree,speakerFour,ClosingHymn,ClosingPrayer")] MeetingPlan meetingPlan)
        {
